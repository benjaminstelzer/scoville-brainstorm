# Scoville Brainstorm benchmark v2
...
V2 removes representation-specific exact Gold exposed by one preserved v1 control diagnostic. It changes no task facts, source fixtures, semantic requirements, or opaque Test payload.
